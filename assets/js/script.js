        ...
        try {
          ...
          if (data.data && data.data.case_set) {
            ...
            if (caseIdentifier == "" && !seoSuffixUrl) {
              ...
              //  contentBox.innerHTML +=await renderCaseDataBB(caseSet.data, count, pageSlug, procedureSlug, targetLinkSelector, apiToken, websitePropertyId, data.data.bragbook_favorite).casesUI;
                ...
                contentBox.innerHTML = await renderCaseDataBB(data, count, pageSlug, '', targetLinkSelector, apiToken, websitePropertyId, fav_data).casesUI;
              }
            } else {
              let images_case = [];
...
async function renderCaseDataBB(data, count, pageSlug, procedureSlug, targetLinkSelector, apiToken, websitePropertyId, favData) {
  ...
  // Wait for all async map results
